...
eval("// html items\nvar headlineHeading = document.getElementById('headline-heading');\nvar headlineText = document.getElementById('headline-text'); // kui headline on poliitika\n// console.log(news.Politics.length);\n// for (let i = 0; i< news.Politics.length; i++ ) {\n//     console.log(news.Politics[i].Heading);\n// }\n// aga et ta võtaks ainult ühe suvalise pealkirja ja kuvaks ekraanile?\n\nvar len = news.Politics.length;\nconsole.log(len); // choose a random number between 0 to amount of arrayitems\n\nconsole.log(Math.floor(Math.random() * 3)); // let headline = news.Politics\n// headlineHeading.innerHTML = \"Peauudis ilmub siia\";\n// headlineText.innerHTML = \"Sisutekst *20\";\n\n//# sourceURL=webpack:///./src/javascript/news-controls.js?");
